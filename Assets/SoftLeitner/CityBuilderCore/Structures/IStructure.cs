...
namespace CityBuilderCore
{
    ...
    public interface IStructure : IKeyed
    {
        ...
        public static void ReplacePoints(IStructure a, IStructure b, Vector2Int point)
        {
            if (a is StructureCollectionFloat collectionFloatA && b is StructureCollectionFloat collectionFloatB)
            {
                ...
                collectionFloatB.Add(point, structure.transform.localPosition, structure.transform.localRotation, structure.transform.localScale);
            }
            ...
            {
                if (a != null)
                    a.Remove(new Vector2Int[] { point });
                if (b != null)
                    b.Add(new Vector2Int[] { point });
            }
        }
        public static void ReplacePoints(IStructure a, IStructure b, IEnumerable<Vector2Int> points)
        {
            if (a is StructureCollectionFloat collectionFloatA && b is StructureCollectionFloat collectionFloatB)
            {
